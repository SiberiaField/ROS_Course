...
def generate_launch_description():
    ...
    rviz_config_path = os.path.join(pkg_project_bringup, 'config', 'crab_bot_sensors.rviz')
    ...
    bridge = Node(
        ...
        parameters=[{
            'config_file': os.path.join(pkg_project_bringup, 'config', 'crab_bot_bridge_sensors.yaml'),
